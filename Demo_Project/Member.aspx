...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
	...
	<div class="bg-img">
		  <form class="container" runat="server">
			<h1 style="font-size:38px">Member Registeration</h1>
			...
			<div class="input">
				...
				<asp:Label ID="Label4" runat="server" Text="Gender:" Font-Bold="True" required></asp:Label><br />
				...
				<asp:Label ID="Label5" runat="server" Text="Contact:" Font-Bold="True"></asp:Label><br />
				<asp:TextBox ID="tb6" runat="server" type="text" placeholder="Number" required  class="validate" autocomplete="off" CssClass="input"></asp:TextBox>
				<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Enter Valid Number" ControlToValidate="tb6" ValidationExpression="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"></asp:RegularExpressionValidator>
			</div>
			  <div class="btn">
